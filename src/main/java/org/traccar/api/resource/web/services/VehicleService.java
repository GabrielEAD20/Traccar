...
public class VehicleService {
    ...
    public VehicleInfoDTO getVehicleInfoBasic(long deviceId) throws StorageException {
        ...
        // Crear el DTO a partir de las variables obtenidas
    ...
    public HumidityAlertDTO getHumidityAlert(long deviceId) throws StorageException {
        ...
        double humidity = latestPosition.getAttributes().containsKey("humidity")
                ? ((Number) latestPosition.getAttributes().get("humidity")).doubleValue()
                : 0.0;
        Date deviceTime = latestPosition.getDeviceTime();
